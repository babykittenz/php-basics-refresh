    ...
    <main>
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <div class="rounded-lg bg-gray-800/50 p-6">
                <h2 class="text-xl font-semibold text-white mb-4">Welcome to your Dashboard</h2>
                <p class="text-gray-300">Your Tailwind CSS is now working properly! This dashboard uses standard HTML elements with Tailwind utility classes.</p>
            </div>
        </div>
    </main>
</div>
